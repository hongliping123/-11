<template>
	<view  v-if="show">
		<view class="more-share-model animated bounceInDown fast" @tap="togle"></view>
		<view class="more-share">
			<view class="more-share-title u-f-ajc animated bounceInDown fast">分享到</view>
			<scroll-view scroll-x class="more-share-body animated bounceInDown fast">
			...
			<view class="more-share-bottom u-f-ajc animated bounceInDown fast" hover-class="more-share-hover" @tap="togle">取消</view>
		</view>
	</view>
</template>
